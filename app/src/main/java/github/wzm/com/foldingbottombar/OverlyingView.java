...
/**
 * Created by wzm on 2017/12/7.
 *
 */

public class OverlyingView extends ViewGroup {
public static final String TAG=OverlyingView.class.getSimpleName();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.i(TAG, "onLayout: left=="+cl);
            Log.i(TAG, "onLayout: top=="+ct);
            Log.i(TAG, "onLayout: right=="+cr);
            Log.i(TAG, "onLayout: bottom=="+cb);
            Log.i(TAG, "onLayout: ===============>");
